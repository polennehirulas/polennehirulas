...
### 🚀 What I'm Working On
* **Deep Learning for Genomics:** Developing novel CNN architectures (see [QuadStack](https://github.com/polennehirulas/QuadStack-Predictor)) to predict G4 formation with structural features.
* **NGS Pipelines:** Building reproducible ChIP-seq analysis workflows using **Galaxy** and **Bash**.
* **Structural Biology:** Investigating ligand interactions with DNA structures using molecular docking tools.
...
My flagship project, **QuadStack**, introduces a strand-invariant CNN architecture that integrates **sequence data** with **novel convolutional blocks**, achieving **0.970 AUC** in G4 prediction.

[👉 Check out the QuadStack Repository](https://github.com/polennehirulas/QuadStack-Predictor)
